...
#Removing tabs at end of lines that appear for some reason
sed 's/[[:blank:]]*$//' ${samplename}/${bamname}_mappedToBaits_baitOnRight.bedpe > ${samplename}/${bamname}_mappedToBaits_baitOnRight.bedpe_tmp
mv ${samplename}/${bamname}_mappedToBaits_baitOnRight.bedpe_tmp ${samplename}/${bamname}_mappedToBaits_baitOnRight.bedpe
